...
SCIP_RETCODE SCIPprobdataWriteSolutionOst(
...
{  /*lint --e{715}*/
   ...
   if( SCIPisEQ(scip, SCIPgetPrimalbound(scip), SCIPgetDualbound(scip)) )
   {
      SCIP_CALL( SCIPprobdataWriteSolutionOst(scip, NULL) );
   }
